var TableManaged = function () {
    ...
    return {
        ...
        init: function () {
            ...
            dicTypeTable =  $('#sample_1').dataTable({
            	"aoColumns": [   
            	                 {
            	                    "mData": "id",	 
            	                 ...
            	                 {   
                                     ...
                                     "mRender": function(data, type, full) { // 返回自定义内容
                                    	 return '<a href="javascript:void(0)" id ="edit" class="btn default btn-xs purple"><i class="fa fa-edit"></i>修改</a>&nbsp;&nbsp;<a href="javascript:void(0)" id="del" class="btn default btn-xs black" onclick ="ModalsManager.dicTypeDel(\'' + data + '\');"><i class="fa fa-trash-o"></i>删除</a>';                                    	
                                     }
                                 }
            	                 ],
            	                 "aoColumnDefs": [{
           ...
           $("#edit").live('click',function(){
        	    ...
        	    var checked =$('#sample_1 tbody tr').find("input[type=checkbox]").is(":checked");
           	   if(checked)
           		{
           		ModalsManager.updateDicTypeModal(); 
   ...
   checkboxCheck: function() {
		   function fnGetSelected(object){
		    ...
		    anSelected = fnGetSelected(dicTypeTable);
       ...
       delSelected: function(){
    	   dicTypeTable.fnDeleteRow(anSelected);
       },
       refreshTable: function(){
    	   dicTypeTable.fnReloadAjax();
