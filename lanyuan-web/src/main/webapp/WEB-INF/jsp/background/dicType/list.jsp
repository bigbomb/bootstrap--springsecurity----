	...
	<div class="page-content-wrapper">
					...
					<div class="portlet box light-grey">
						...
						<div class="portlet-body">
							<div class="table-toolbar">
								...
								<a class="btn green" onclick = "ModalsManager.addDicTypeModal();" role="button">
									添加 <i class="fa fa-plus"></i>
									</a>
									
									<a class="btn yellow" role="button" onclick = "ModalsManager.updateDicTypeModal();">
									修改 <i class="fa fa-edit"></i>
									</a>
									
									<a  class="btn red" role="button"  onclick = "ModalsManager.batchDicTypeDel();">
		...
		<!-- 添加dic模式化窗口 -->
								...
								<div class="modal-body">
								    	...
								    	<div class="form-group">
											...
											<div class="input-icon">
												...
												<input class="form-control placeholder-no-fix" type="text" placeholder="Key" name="dicTypeKey" id = "dicTypeKey"/>
										    </div>
										</div>
									    <div class="form-group">
									    	<label class="control-label visible-ie8 visible-ie9">名称</label>
											<div class="input-icon">
												<select class="form-control placeholder-no-fix"  name="dicTypeName" id = "dicTypeName">
			...
			<div id="update-Dic" class="modal" tabindex="-1" data-backdrop="static" data-keyboard="false" data-focus-on="input:first" data-width="350">
								<div class="modal-header">
									<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
									<h4 class="modal-title">更新字典类型</h4>
								</div>
								...
								<div class="modal-body">
								    	...
								    	<div class="form-group">
											...
											<div class="input-icon">
												<i class="fa  fa-pencil"></i>
												<input class="form-control placeholder-no-fix" type="text" placeholder="Key" name="udicTypeKey" id = "udicTypeKey"/>
										    </div>
										</div>
									    <div class="form-group">
									    	<label class="control-label visible-ie8 visible-ie9">名称</label>
											<div class="input-icon">
												<i class="fa  fa-pencil"></i>
												<input class="form-control placeholder-no-fix" type="text" placeholder="名称" name="udicTypeName" id = "udicTypeName"/>
											</div>
										</div>								   
									    <div class="form-group">
									    	<label class="control-label visible-ie8 visible-ie9">描述</label>
...
<script src="${pageContext.request.contextPath}/assets/scripts/dicType_T.js"></script>
<script src="${pageContext.request.contextPath}/assets/scripts/fnReloadAjax.js"></script>
<script src="${pageContext.request.contextPath}/assets/scripts/dicType_M.js"></script>
