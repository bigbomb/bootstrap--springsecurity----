						...
						<div class="portlet-body">
							...
							<div class="table-toolbar">
								...
								<a class="btn green" onclick = "ModalsManager.addDicModal();" role="button">
								    ...
								    <a  class="btn purple" role="button"  onclick = "">
									导出excel <i class="fa fa-minus"></i>
									</a>
									<a  class="btn dark" role="button"  onclick = "">
									分配角色 <i class="fa fa-minus"></i>
									</a>
								...
								<div class="modal-body">
								    	...
								    	<div class="form-group">
											...
											<div class="input-icon">
												...
												<input class="form-control placeholder-no-fix" type="text" placeholder="账号" name="accountName" id = "accountName"/>
										    </div>
										</div>
									    <div class="form-group">
...
<script src="${pageContext.request.contextPath}/assets/scripts/acc_T.js"></script>
<script src="${pageContext.request.contextPath}/assets/scripts/fnReloadAjax.js"></script>
<script src="${pageContext.request.contextPath}/assets/scripts/acc_M.js"></script>
