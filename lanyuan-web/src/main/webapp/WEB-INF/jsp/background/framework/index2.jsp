...
<script type="text/javascript">
	...
	$(function() {
		...
		$.ajax({
			...
			type : "POST",
			//data : $("#from").serialize(),
			url : rootPath + '/background/resources/resources.html',
			dataType : 'json',
  ...
  <div style="PADDING-RIGHT:0px; PADDING-LEFT:0px; PADDING-BOTTOM:0px; PADDING-TOP:0px; WIDTH:100%; HEIGHT:148px; border:1px solid #cacaca;background: #FFFFFF">
	   ...
	   <iframe width="400" scrolling="no" height="120" frameborder="0" allowtransparency="true" src="http://i.tianqi.com/index.php?c=code&id=19&bgc=%23FFFFFF&bdc=%23&icon=1&temp=1&num=2"></iframe>
				...
				<div id="part1" class="leaf one">
					...
					<div class="skin">
						<div style="font-size: 14px;text-align: left;padding: 10px;">
							感谢捐助者:<br>
							沧海一粟 200元　Alias 5元　Could 10元　lee 100元　逗留 5元  小滴棍 50元 张XX名 4元
						</div>
</div>
					</div>
				</div>
				...
				<div id="part1" class="leaf one">
					...
					<td><a href="https://me.alipay.com/lanyuansystem" title="蓝缘系统的支付连接" style="font-size: 17px;color: blue;" target="_blank">https://me.alipay.com/lanyuansystem</a></td>
					</tr>
					<tr>
					<td>技术支持:</td>
						...
						<div style="float: right; width: 83%;" id="framecenter">
							<div class="box-content" tabid="home" title="我的主页">
								...
								<div style="padding-left: 20px;">
							       ...
							       以下是蓝缘系统捐助的支付页面，由于空间网站需求收费，故此征集大家为蓝缘系统做一点贡献，有了你的支持，蓝缘系统将做得更好，服务开源，献身开源！再次致谢 ！
							     </div>  <br><img alt="蓝缘系统的支付连接" src="${ctx}/images/zhifubao.png" title="蓝缘系统的支付连接">　　　　<a href="https://me.alipay.com/lanyuansystem" title="蓝缘系统的支付连接" style="font-size: 17px;color: blue;" target="_blank">https://me.alipay.com/lanyuansystem</a>
								</div></div>
							</div>
						</div>
					</div>
