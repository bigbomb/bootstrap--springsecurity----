...
jQuery.validator.addMethod("checkpass", function(value, element) {
	...
	$(function() {
		getSelectBydicType("type","${dic.dicTypeId}");//调用字典ajax
		selectCheck("dicName","${dic.dicName}");
		$("form").validate({
	...
	function getTypeDetail(id){
		$.ajax({
		    ...
		    data:{"id":id},
		    success : function(data){
		    	document.getElementById("typeDescription").innerHTML = data.description;
		...
		<table style="width: 285px; height: 200px;">
			<tbody>
				...
				<tr>
					...
					<td class="l_left">
					<select name="dicName" id="dicName" style="width: 140px;">
							 <option value="">--请选择--</option>
     						 <option value='目录' >目录</option>
     						 <option value='菜单' >菜单</option>
    						 <option value='按扭' >按扭</option>
				...
				<tr>
					...
					<td class="l_left">
					<select name="type" id="type" style="width: 140px;" onchange="getTypeDetail(this.value)">
							 <option value="">--请选择--</option>
				...
				<tr>
					<td class="l_right">类型描述：</td>
					<td class="l_left">
					<span id="typeDescription"></span>
					<!--  <input id='typeDescription' name="'typeDescription'" class="" type="text" value="" disabled = "disabled">-->
					<input id='dicTypeId' name="dicTypeId" type="hidden" value="">
